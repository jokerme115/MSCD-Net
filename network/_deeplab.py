...
class DeepLabHead(nn.Module):
    def __init__(self, in_channels, num_classes, aspp_dilate=[12, 24, 36], use_attention=False):
        ...
        if self.use_attention:
            self.cbam = CBAM(256)  # ASPP输出通道数是256
...
class DeepLabHeadV3Plus(nn.Module):
    def __init__(self, in_channels, low_level_channels, num_classes, aspp_dilate=[12, 24, 36], use_attention=False):
